...
you can also use it directly in posts or pages,
...
They're to be missing from the documentation, but Liquid also has hashes:
objects with multiple named fields.  Jekyll passes several hashes into your
...
(See [Jekyll's template variables](https://jekyllrb.com/docs/variables/) for the full list.)
...
page has an attribute `does_exist: true` in its Jekyll front matter, but it
